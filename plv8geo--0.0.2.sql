...
/** This will insert all javascript modules into a table **/insert into plv8_modules values ('topojson',false,$js$// https://github.com/topojson/topojson Version 3.0.0. Copyright 2017 Mike Bostock.
...
$js$);insert into plv8_modules values ('geotiff',false,$js$(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
	typeof define === 'function' && define.amd ? define(['exports'], factory) :
	(factory((global.GeoTIFF = global.GeoTIFF || {})));
}(this, (function (exports) { 'use strict';
...
exports.GeoTIFF = main;
Object.defineProperty(exports, '__esModule', { value: true });

})));
$js$);insert into plv8_modules values ('delaunator',false,$js$(function (global, factory) {
...
$js$);insert into plv8_modules values ('d3',false,$js$// https://d3js.org Version 4.9.1. Copyright 2017 Mike Bostock.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
	typeof define === 'function' && define.amd ? define(['exports'], factory) :
...
$js$);insert into plv8_modules values ('d3-contour',false,$js$// https://d3js.org/d3-contour/ Version 1.1.1. Copyright 2017 Mike Bostock.
(function (global, factory) {
...
$js$);insert into plv8_modules values ('d3-force',false,$js$// https://d3js.org/d3-force/ Version 1.0.6. Copyright 2017 Mike Bostock.
(function (global, factory) {
...
$js$);insert into plv8_modules values ('d3-hexbin',false,$js$// https://github.com/d3/d3-hexbin Version 0.2.2. Copyright 2017 Mike Bostock.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
	typeof define === 'function' && define.amd ? define(['exports'], factory) :
	(factory((global.d3 = global.d3 || {})));
...
$js$);insert into plv8_modules values ('d3-geo',false,$js$// https://d3js.org/d3-geo/ Version 1.6.4. Copyright 2017 Mike Bostock.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-array'], factory) :
	(factory((global.d3 = global.d3 || {}),global.d3));
...
d3_slopecontours
**/
DROP FUNCTION IF EXISTS plv8.d3_slopecontours(gtiff bytea,tresholds int);
...
var result = earcut(data.vertices); 
var endT = new Date();
//plv8.elog(NOTICE, 'CalcTime: ' + (endT - startT) / 1000);
var triangles = [];
...
for (i = 0; triangles && i < triangles.length; i += 3) {
    let triangle = [triangles.slice(i, i + 3)];
    triangle[0].push(triangle[0][0]);
    returnval.coordinates.push(triangle);
}
return returnval;
$$;
...
WITH poly AS (
SELECT ST_GeomFromText('POLYGON((-71.1031880899493 42.3152774590236,
...
-71.1031880899493 42.3152774590236))',4326) geom
)
,earcut AS ( --15 ms
	SELECT plv8.earcut(ST_AsGeoJson(geom)::JSONB) 
	FROM poly
),
tesselate AS ( --26 ms
	SELECT ST_Tesselate(geom)
	FROM poly
)
SELECT count(*) from earcut;
*//**
slope
**/
